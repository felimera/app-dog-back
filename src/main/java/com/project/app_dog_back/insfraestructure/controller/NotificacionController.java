...
import com.project.app_dog_back.domain.service.INotificacionService;
...
@Tag(name = "Notificacion", description = "Operations related to system notifications.")
@RestController
...
public class NotificacionController {
    ...
    @Autowired
    public NotificacionController(INotificacionService iNotificacionService, IMetaService iMetaService) {
    ...
    @PostMapping
    public ResponseEntity<Response> create(@Valid @RequestBody NotificacionDto dto, BindingResult bindingResult) {
        log.info("Creating Notificacion: {}", dto);
        ...
        response.setData(iNotificacionService.create(dto));
    ...
    public ResponseEntity<Response> getById(@PathVariable(name = "id") Long id) {
        ...
        response.setData(iNotificacionService.getById(id));
    ...
    public ResponseEntity<Response> getAll() {
        ...
        response.setMeta(meta);
        response.setPagination(Pagination.builder().build().toPaginationBuilder());
        response.setData(iNotificacionService.getAll());
