...
public class SalidaController {
    ...
    @Autowired
    public SalidaController(ISalidaService iSalidaService, IMetaService iMetaService) {
    ...
    @PostMapping
    public ResponseEntity<Response> create(@Valid @RequestBody SalidaDto dto, BindingResult bindingResult) {
        log.info("Creating Salida: {}", dto);
